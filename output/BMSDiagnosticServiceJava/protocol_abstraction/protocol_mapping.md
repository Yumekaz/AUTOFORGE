...
Service: `BMSDiagnosticServiceJava`
...
|---|---:|---|
| `GetBatteryStatus` | `0x1` | `POST /bms/diagnostics` |
| `GetCellVoltages` | `0x2` | `POST /bms/diagnostics` |
| `GetEstimatedRange` | `0x3` | `POST /bms/diagnostics` |
